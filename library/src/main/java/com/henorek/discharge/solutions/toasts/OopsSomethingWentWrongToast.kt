...
class OopsSomethingWentWrongToast(context: Context) : Solvable {

  private val toast: DischargeToast

  init {
    toast = DischargeBuilder.toast(context).withMessage(R.string.discharge_oops_something_went_wrong).withDuration(
